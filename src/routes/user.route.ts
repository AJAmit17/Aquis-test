...
import { deleteUserById, fetchAllUsers, fetchUserById, updateUserById } from '#src/controllers/user.controller.js';
...
router.get('/:id', authenticateToken, fetchUserById as unknown as express.RequestHandler);

// PUT /users/:id - Update user by ID (authenticated users can update own profile, admin can update any)
router.put('/:id', authenticateToken, updateUserById as unknown as express.RequestHandler);
